...
If you already have all the pre-requisites, skip to the [build](windows-instructions.md#building) steps below.
  ...
  2. Install **[Visual Studio 2022](https://www.visualstudio.com/downloads/)** (Version 17.8 or later). The Community version is completely free. When configuring your installation, include these components at minimum:
