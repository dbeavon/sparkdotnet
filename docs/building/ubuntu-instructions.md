...
## Building .NET Sample Applications using .NET CLI
...
Once you build the samples, you can use `spark-submit` to submit your .NET apps. Make sure you have followed the [pre-requisites](#pre-requisites) section and installed Apache Spark.
